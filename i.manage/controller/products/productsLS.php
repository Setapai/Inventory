      ...
      <tr>
        ...
        <td >
            <div class="row justify-content-center align-items-center">
              <div class="col-sm">
                <button id="updateLS" type="submit" class="m-2 btn btn-outline-info btn-sm" value='.$row['id'].' data-toggle="modal" data-target="#lsUpdateModal"> <i class="bi bi-pencil-square"></i> Update</button>
              </div>
          </div>
        </td>
