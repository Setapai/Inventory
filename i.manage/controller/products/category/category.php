...
$output = '
<label>Total Models - '.$total_data.'</label>
    ...
    if ($_SESSION['accStatus'] == 'Admin') {
      ...
      <td>
          <div class="row justify-content-center align-items-center">
            <div class="col-sm">
              <button id="categoryDelete" type="button" class="m-2 btn btn-outline-danger btn-sm" value='.$row['id'].'> <i class="bi bi-x-circle"></i> delete</button>
            </div>
        </div>
      </td>
      ';
