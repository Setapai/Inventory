...
DATE_FORMAT(order_records.date, '%Y/%b/%D')  AS dateTime,
...
if ($_POST['yearSelect']  !=  '') {
  $text = $_POST['query'];
  $select = $_POST['yearSelect'];
  $query .= "
  AND YEAR(date) = '$select' AND  order_records.receipt LIKE '%$text%'
  ";
...
$output = '
<label>This Year Loans Records - '.$total_data.'</label>
